...
(function ($) {
    $.fn.bjqs1 = function (options) {
        ...
        if (settings.showControls && slideCount > 1) {
            ...
            // Create the elements for the controls
            var $controlContainer = $('<ul class="bjqs-controls"></ul>'),
                $next = $('<li><a style="float: right;position:relative;" href="#" class="bjqs-next" class="controls">' + settings.nextText + '</a></li>'),
                $previous = $('<li><a style="margin-left:-7px;margin-top: -310px;position:relative;" href="#" class="bjqs-prev" class="controls">' + settings.prevText + '</a></li>');
        ...
        if (settings.showMarkers && slideCount > 1) {
            ...
            var $markerContainer = $('<ol style="position: absolute;top: 1220px;" class="bjqs-markers"></ol>'),
                $marker, markers, offset;
        ...
        if (settings.hoverPause && settings.automatic) {
            ...
            $container.hover(function () {
                if (!paused) {
                    clearInterval(bjqsInterval1);
                    paused = true;
                }
            }, function () {
                if (paused) {
                    bjqsInterval1 = setInterval(function () {
                        bjqsGo(forward)
                    }, settings.rotationSpeed);
                    paused = false;
                }
        ...
        var checkPosition = function (direction) {
            ...
            // Kick off the rotation if we're on auto pilot, but only if we have more than 1 slide (thanks Efrain!)
        if (settings.automatic && slideCount > 1) {
            var bjqsInterval1 = setInterval(function () {
                bjqsGo(forward, false)
            }, settings.rotationSpeed);
        }
...
(function ($) {
    $.fn.bjqs2 = function (options) {
        ...
        if (settings.showMarkers && slideCount > 1) {
            ...
            var $markerContainer = $('<ol style="position: absolute;top: 1580px;" class="bjqs-markers"></ol>'),
                $marker, markers, offset;
        ...
        if (settings.hoverPause && settings.automatic) {
            ...
            $container.hover(function () {
                if (!paused) {
                    clearInterval(bjqsInterval2);
                    paused = true;
                }
            }, function () {
                if (paused) {
                    bjqsInterval2 = setInterval(function () {
                        bjqsGo(forward)
                    }, settings.rotationSpeed);
                    paused = false;
                }
        ...
        var checkPosition = function (direction) {
            ...
            // Kick off the rotation if we're on auto pilot, but only if we have more than 1 slide (thanks Efrain!)
        if (settings.automatic && slideCount > 1) {
            var bjqsInterval2 = setInterval(function () {
                bjqsGo(forward, false)
            }, settings.rotationSpeed);
        }
